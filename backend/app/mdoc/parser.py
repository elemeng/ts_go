    ...
    try:
        ...
        for line in lines:
            ...
            if line.startswith("[ZValue ="):
                ...
                current_frame = Frame(
                    zIndex=z_value, angle=0.0, mrcPath="", selected=True
                )
                    ...
                    if key == "TiltAngle":
                        ...
                        if matched_path:
                            ...
                            if matched_path:
                                ...
                                current_frame.mrcPath = (
                                    filename  # Keep original if no match
                                )
        ...
        if not frames:
            raise HTTPException(
                status_code=400, detail=f"No frames found in mdoc: {mdoc_path}"
            )
